...
class NotesStream extends StatelessWidget {
  ...
  NotesStream({firestore, this.user}) : _firestore = firestore;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final notes = snapshot.data.documents.where((DocumentSnapshot document)=> document['user']['correo'] == this.user.email).toList();
        //
